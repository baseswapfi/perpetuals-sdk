...
export interface PositionUtilsInterface extends utils.Interface {
  ...
  getFunction(nameOrSignatureOrTopic: "BASIS_POINTS_DIVISOR"): FunctionFragment;
...
export interface LeverageDecreasedEventObject {
...
export type LeverageDecreasedEvent = TypedEvent<
  ...
  LeverageDecreasedEventObject
>;

export type LeverageDecreasedEventFilter =
  TypedEventFilter<LeverageDecreasedEvent>;
